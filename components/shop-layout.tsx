...
export default function ShopLayout({ title, description, products, categoryFilters }: ShopLayoutProps) {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 md:px-8 py-10 md:py-14">
      ...
      {/* Filter Bar */}
      <div className="flex flex-col gap-4 mb-8 pb-6 border-b border-stone-100 dark:border-stone-800">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="flex items-center gap-2 text-xs text-stone-600 dark:text-stone-400 hover:text-stone-900 dark:hover:text-stone-200 transition sm:hidden"
            >
            ...
            <select
              ...
              className="text-xs text-stone-700 dark:text-stone-300 border border-stone-200 dark:border-stone-700 px-3 py-2 bg-white dark:bg-stone-800 focus:outline-none focus:border-stone-400 dark:focus:border-amber-600"
            >
              {SORT_OPTIONS.map((o) => (
      ...
      <div className={`mb-8 ${showFilters ? 'block' : 'hidden sm:block'}`}>
        <p className="text-xs uppercase tracking-widest text-stone-400 dark:text-stone-500 mb-3">Price Range</p>
        <div className="flex flex-wrap gap-2">
      ...
      {/* Results count */}
      <p className="text-xs text-stone-400 dark:text-stone-500 mb-6">{filtered.length} products</p>
